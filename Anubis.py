...
class Widget(QWidget):
    ...
    def Saving(s):
        ...
        if (lastChar == "py"):
            ...
            with open('CSharpmain.cs', 'w') as f:
                TEXT = text.toPlainText()
                f.write(TEXT)
...
class UI(QMainWindow):
    ...
    def intUI(self):
        ...
        Python_Action.triggered.connect(self.ChoosebPy)
        CSharp_Action = QAction("C#", self)
        CSharp_Action.triggered.connect(self.ChoosenCSharp)
